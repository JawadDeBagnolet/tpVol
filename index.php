    ...
    ?>
        ...
        <header class="masthead">
            <div class="container">
                ...
                <a class="btn btn-primary btn-xl text-uppercase" href="vue/reservation.php">Réserver</a>
            </div>
        </header>
        <!-- Services-->
        ...
        <section class="page-section bg-light" id="team">
            <div class="container">
                <div class="text-center">
                    <h2 class="section-heading text-uppercase">Our Dream Team</h2>
                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/assets/img/team/NEYMAR.jpg" alt="..." />
                            <h4>Neymar Santos JR</h4>
                            <p class="text-muted">Left Winger</p>
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/assets/img/team/SUAREZ.jpg" alt="..." />
                            <h4>Luis Suarez</h4>
                            <p class="text-muted">Stricker</p>
                    ...
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="assets/assets/img/team/MESSI.png" alt="..." />
                            <h4>Lionel Messi</h4>
                            <p class="text-muted">Right Winger</p>
