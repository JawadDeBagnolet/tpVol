        ...
        <div class="d-flex justify-content-center">
            <div class="text-center">
                <form action="../src/traitement/gestionConnexion.php" method="post">
                    ...
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        ...
                        <div class="form-floating">
                            <input name="emailCo" type="text" class="form-control" id="floatingInputGroup2" placeholder="E-mail" style="width: 100%;" size="30">
                    ...
                    <div class="input-group mb-3" style="margin-top: 10px;">
                        <span class="input-group-text">🔒</span>
                        <div class="form-floating">
                            <input name="mdpCo" type="password" class="form-control" id="floatingInputGroup2" placeholder="Mot de Passe" style="width: 100%;" size="30">
                ...
                <div class="lienInscription" style="margin-top: 10px;">
                    Vous n'avez pas de compte ? Je souhaite <a href="inscription.php" class="header-button">M'inscrire</a> !
                </div>
            </div>
        </div>
    </div>
